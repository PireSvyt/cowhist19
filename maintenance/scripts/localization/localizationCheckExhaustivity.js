...
alternativeLocalizations.forEach(localization => {
    console.log("     . " + localization + " : " + 
        Math.floor(MissingKeyList[localization].length / defaultLocalizationKeys.length * 100) + 
        "% (" + MissingKeyList[localization].length + ")")
})
console.log("  -  To delete keys :")
alternativeLocalizations.forEach(localization => {
    console.log("     . " + localization + " : " + 
        Math.floor(ToDeleteKeyList[localization].length / alternativeLocalizationKeys[localization].length * 100) + 
