...
} from './_services/auth.services.js'
// Reducers
...
export default function SignInModal() {
    ...
    const select = {
        ...
        sendactivation: useSelector(
            (state) => state.signinModalSlice.sendactivation
        ),
        sendpassword: useSelector(
            (state) => state.signinModalSlice.sendpassword
        ),
    }
            ...
            >
                        ...
                        <FormControl>
                            ...
                            {select.sendpassword.status === 'sent' ? (
                                ...
                                >
                                    ...
                                    >
                                        {t(
                                            'signin.label.successsendingpassword'
                                        )}
                                    </Typography>
                                </Box>
                            ) : null}
                            ...
                            {select.status === 'inactivated' ? (
                                ...
                                >
                                    ...
                                    <LoadingButton
                                        ...
                                        disabled={
                                            select.sendactivation.disabled ||
                                            select.sendactivation.status ===
                                                'sent'
                                        }
                                    ...
                                    >
                                        {t(
                                            'signin.button.resendactivationemail'
                                        )}
                                    </LoadingButton>
                                </Box>
                            ) : null}
                            ...
                            {select.sendactivation.status === 'sent' ? (
                                ...
                                >
                                    ...
                                    >
                                        {t(
                                            'signin.label.successresendingactivation'
                                        )}
                                    </Typography>
                                </Box>
                            ) : null}
                ...
                <DialogActions>
                    ...
                    <LoadingButton
                        ...
                        disabled={
                            select.disabled || select.status === 'inactivated'
                        }
