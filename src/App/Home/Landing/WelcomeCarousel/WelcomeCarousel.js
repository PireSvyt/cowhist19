...
import EasyImage from './_resources/easybro.gif'
import TableImage from './_resources/Table.png'
import AnalyticsImage from './_resources/Analytics.png'
...
export default function WelcomeCarousel() {
    ...
    // Render
    return (
        <Box sx={{ mt: 1, mb: 3 }} data-testid="component-carousel">
            <AliceCarousel
                autoPlay
