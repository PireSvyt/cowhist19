...
// Service
import { serviceUserGetStats } from '../../_shared/_services/user/user.services.js'
...
export default function MyStats() {
    ...
    return (
        <Box data-testid="component-my stats">
            <Typography
                    ...
                    >
                        ...
                        >
                            <CircularProgressWithLabel
                                value={select.stats.rateattack * 100 || 0}
                            />
                            <Typography
                                variant="body1"
                                component="span"
                        ...
                        >
                            <CircularProgressWithLabel
                                value={select.stats.ratevictory * 100 || 0}
                            />
                            <Typography
                                variant="body1"
                                component="span"
