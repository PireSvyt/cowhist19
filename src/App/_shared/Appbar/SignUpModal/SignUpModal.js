...
// Services
import { serviceAuthSignUp } from '../../_services/auth/auth.services.js'
// Reducers
            ...
            >
                ...
                >
                    ...
                    >
                        <TextField
                            ...
                            autoComplete="off"
                            error={
                                select.errors.pseudo ||
                                select.errors.existingpseudo
                            }
                            helperText={
                                select.errors.existingpseudo
                                    ? t('signup.error.existingpseudo')
                                    : null
                            }
                        />
                        <TextField
                ...
                <DialogActions>
                    ...
                    <LoadingButton
                        ...
                        disabled={
                            select.disabled || select.errors.alreadysignedup
                        }
