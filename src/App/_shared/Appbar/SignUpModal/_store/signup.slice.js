        ...
        change: (state, action) => {
            ...
            if (action.payload.inputs !== undefined) {
                ...
                if (action.payload.inputs.passwordrepeat !== undefined) {
                    state.inputs.passwordrepeat =
                        action.payload.inputs.passwordrepeat
                }
            }
            // Errors
            if (action.payload.errors !== undefined) {
                ...
                if (action.payload.errors.passwordrepeat !== undefined) {
                    state.errors.passwordrepeat =
                        action.payload.errors.passwordrepeat
                }
                if (action.payload.errors.existingpseudo !== undefined) {
                    state.errors.existingpseudo =
                        action.payload.errors.existingpseudo
                }
                if (action.payload.errors.alreadysignedup !== undefined) {
                    state.errors.alreadysignedup =
                        action.payload.errors.alreadysignedup
                }
            }
            // Lock
