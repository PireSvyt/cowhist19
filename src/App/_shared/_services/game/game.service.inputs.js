                    ...
                    subchecks: [
                        {
                            ...
                            checkfunction: (serviceInputs) => {
                                console.log(
                                    'BEG gameCreateInputs.sercivechecks'
                                )
                                ...
                                for (
                                    let c = 0;
                                    c < serviceInputs.inputs.contracts.length;
                                    c++
                                ) {
                                    console.log(
                                        '>> Check contract is correct :',
                                        serviceInputs.inputs.contracts[c]
                                    )
                                    let contractChecks = [
                                        {
                                            field: 'inputs',
                                            ...
                                            subchecks: [
                                                    ...
                                                    subchecks: [
                                                        {
                                                            ...
                                                            checkfunction: (
                                                                ...
                                                                console.log(
                                                                    '*** serviceInputs.tableContracts',
                                                                    serviceInputs.tableContracts
                                                                )
                                                                console.log(
                                                                    '*** serviceInputs.inputs.contract',
                                                                    serviceInputs
                                                                        .inputs
                                                                        .contract
                                                                )
                                                ...
                                                },
                                                {
                                                    ...
                                                    checkfunction: (
                                                        ...
                                                        console.log(
                                                            '*** Checking outcome is well formed'
                                                        )
                                                        let fullContract =
                                                            Object.values(
                                                                serviceInputs.tableContracts
                                    ...
                                    let contractCheckOutcome =
                                        serviceProceedCheck(
                                            {
                                                inputs: serviceInputs.inputs
                                                    .contracts[c].inputs,
                                                tableContracts:
                                                    serviceInputs.tableContracts,
                                            },
                                    ...
                                    if (
                                        contractCheckOutcome.proceed === false
                                    ) {
                                        contractsCheckOutcome.proceed = false
                                    }
                                    contractCheckOutcome.errors.forEach(
                                        (err) => {
                                            console.log(
                                                '>> > contractCheckOutcome.errors',
                                                err
                                            )
                                            contractsCheckOutcome.errors.push(
                                                err
                                            )
                                        }
                                    )
                                    Object.keys(
                                        contractCheckOutcome.stateChanges
                                    ).forEach((key) => {
                                        console.log(
                                            '>> > contractCheckOutcome.stateChanges',
                                            key
                                        )
                                        contractsCheckOutcome.stateChanges[
                                            key
                                        ] =
                                            contractCheckOutcome.stateChanges[
                                                key
                                    ...
                                    console.log(
                                        '   gameCreateInputs.sercivechecks contractCheckOutcome',
                                        contractCheckOutcome
                                    )
                                }
                                console.log(
                                    'END gameCreateInputs.sercivechecks contractsCheckOutcome',
                                    contractsCheckOutcome
                                )
...
export const gameDeleteInputs = {
    ...
    getmanageresponsefunction: (response, log) => {
        ...
        let responses = {
            'game.delete.success': () => {
                console.log(
                    'gameDeleteInputs.getmanageresponsefunction game.delete.success'
                )
                appStore.dispatch({
                    type: 'sliceSnack/change',
                    payload: {
