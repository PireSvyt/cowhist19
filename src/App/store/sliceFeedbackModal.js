...
const sliceFeedbackModal = createSlice({
  name: "sliceFeedbackModal",
  initialState: {
    open: false,
    title: "",
    contents: [],
  ...
  reducers: {
    change: (state, action) => {
        if (process.env.REACT_APP_DEBUG === "TRUE") {
            console.log("sliceFeedbackModal.change");
    ...
    close: (state) => {
        if (process.env.REACT_APP_DEBUG === "TRUE") {
            console.log("sliceFeedbackModal.close");
        }
        state.open = false;
        state.title = "";
        state.contents = [];
    ...
    lock: (state, action) => {
        if (process.env.REACT_APP_DEBUG === "TRUE") {
            console.log("sliceFeedbackModal.lock");
            //console.log(action.payload);
        }
        state.disabled = true;
        state.loading = true;
...
export default sliceFeedbackModal.reducer;
