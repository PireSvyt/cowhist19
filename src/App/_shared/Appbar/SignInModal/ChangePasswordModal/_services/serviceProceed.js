...
async function serviceProceed() {
    ...
    try {
        ...
        const changePasswordInputs = {
            ...appStore.getState().sliceChangePasswordModal.inputs,
        }
        ...
        if (proceedCheckOutcome.proceed === true) {
            ...
            changePasswordInputs.newpassword = bcrypt.hashSync(
                changePasswordInputs.new
            )
            ...
            if (process.env.NODE_ENV === '_production') {
                ...
                changePasswordInputs.currentpassword =
                    changePasswordInputs.current
