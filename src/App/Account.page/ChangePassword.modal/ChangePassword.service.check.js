function ChangePasswordServiceCheck(changePasswordInputs) {
    if (process.env.REACT_APP_DEBUG === "TRUE") {
        console.log("ChangePasswordServiceCheck");
    }
    let proceed = true;
    let errors = [];
    let stateChanges = {};
    ...
    if (changePasswordInputs.current === null || changePasswordInputs.current === "") {
        proceed = false;
    ...
    if (changePasswordInputs.new === null || changePasswordInputs.new === "") {
        ...
        // Is repeat empty?
        if (changePasswordInputs.repeat === null || changePasswordInputs.repeat === "") {
            proceed = false;
...
export default ChangePasswordServiceCheck;
