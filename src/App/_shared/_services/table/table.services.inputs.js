                            ...
                            subchecks: [
                                {
                                    ...
                                    checkfunction: (serviceInputs) => {
                                        if (
                                            ...
                                            return {
                                                errors: [
                                                    'table.error.creationwithoutuser',
                                                ],
                                                stateChanges: {
                                                    errors: { players: true },
                                                },
...
export const tableGetDetailsInputs = {
    ...
    apicall: async (inputs, log) => {
        ...
        try {
            return await apiTableGetDetails(
                inputs.tableid,
                appStore.getState().authSlice.token
            )
        } catch (err) {
