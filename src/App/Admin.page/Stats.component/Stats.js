...
// Services
//import serviceGetTablesByPlayers from "../components/Stats/services/serviceGetTablesByPlayers.js";
//import serviceGetTablesByGames from "../components/Stats/services/serviceGetTablesByGames.js";
import GetUsersByStatusService from "./GetUsersByStatus.service.js"
import GetObjectCountService from "./GetObjectCount.service.js";
...
export default function Stats() {
  ...
  const select = {
    ...
    statsLoaded: useSelector((state) => state.sliceStats.loaded),
    stats: useSelector((state) => state.sliceStats.stats),
    statsState: useSelector((state) => state.sliceStats.state),
  };
