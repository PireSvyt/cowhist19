...
async function serviceProceed(
    ...
    try {
        ...
        if (
            serviceProceedInputs.getcheckoutcomedispatchfunction !== undefined
        ) {
            if (debugProceed) {
                console.log('serviceInputs')
                Object.keys(serviceInputs).forEach((k) => {
            ...
            if (proceedCheckOutcome.stateChanges !== undefined) {
                appStore.dispatch({
                    type: serviceProceedInputs.getcheckoutcomedispatchfunction(
                        log
                    ),
        ...
        if (proceedCheckOutcome.proceed === true) {
            ...
            if (serviceProceedInputs.repackagingfunction !== undefined) {
                if (serviceProceedInputs.repackagingfunction !== undefined) {
                    serviceInputs =
                        await serviceProceedInputs.repackagingfunction(
                            serviceInputs,
                            log
                        )
                }
