...
// Services
import ChangePasswordAPI from "./ChangePasswordAPI.js";
import ChangePasswordServiceCheck from "./ChangePasswordServiceCheck.js";
// Shared
...
async function ChangePasswordService() {
  ...
  try {
    ...
    // Check inputs
    let proceedCheckOutcome = ChangePasswordServiceCheck(changePasswordInputs);
    appStore.dispatch({
    ...
    if (proceedCheckOutcome.proceed === true) {
        ...
        // API call
        let data = await ChangePasswordAPI(changePasswordInputs);
        switch (data.type) {
