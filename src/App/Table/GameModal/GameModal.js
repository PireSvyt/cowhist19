...
// Components
import ContractCard from './ContractCard/ContractCard.js'
// Services
import { serviceGameCreate } from '../../_shared/_services/game/game.services.js'
...
export default function GameModal() {
    ...
    const changes = {
        save: () => {
            console.log(
                'GameModal.changes.save gameContracts',
                select.gameContracts
            )
            serviceGameCreate()
        },
        close: () => {
    ...
    return (
        <Box>
            ...
            >
                ...
                >
                    <Box data-testid="modal-game#list-contracts">
