...
// Services
import serviceActivate from './_services/serviceActivate.js'
import serviceActivateCheck from './_services/serviceActivateCheck.js'
import serviceSendActivation from '../_shared/_services/auth/serviceSendActivation.js'
import serviceSendActivationCheck from '../_shared/_services/auth/serviceSendActivationCheck.js'
// Components
...
export default function Activation() {
    ...
    return (
        <Box data-testid="page-activation">
            ...
            {activationStatus === 'activated' ? (
                ...
                >
                    ...
                    <Button
                        ...
                        data-testid="box-account is activated#button-open sign in modal"
                    >
            ...
            {activationStatus === 'error' ? (
                ...
                >
                    ...
                    <LoadingButton
                        ...
                        data-testid="component-error while activating#button-resend activation email"
                    >
